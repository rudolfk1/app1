import {
  ...
  useThree
<<<<<<< HEAD
} from "./chunk-NNKUSJE6.js";
import {
  require_react
} from "./chunk-NVDSUZN5.js";
=======
} from "./chunk-FUWA2ZUA.js";
>>>>>>> 435ed70f8b69cab74eb35a13754f1d52507e743d
import {
  __commonJS,
  __publicField,
  __toESM,
  require_react
} from "./chunk-MKGDGZDQ.js";
...
var propsToBody = (options) => {
  ...
  if (type === "Compound") {
    shapes.forEach((_ref3) => {
      ...
      const shapeBody = body.addShape(createShape(type2, args2), position2 ? new Vec3$1(...position2) : void 0, rotation2 ? new Quaternion$1().setFromEuler(...rotation2) : void 0);
      if (material2)
